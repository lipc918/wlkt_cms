...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'edusoho', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6af9bfc4e466d92ebaad218a4b475486aed4479807e8f38e510312bd7a88befc');
        return $instance;
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'hmecnu9qe7wck48wo04ckcsc0k80o8c');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $w = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'hmecnu9qe7wck48wo04ckcsc0k80o8c', 'main', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    {
        return $this->services['session.handler.pdo'] = new \Topxia\WebBundle\Handler\UserPdoSessionHandler($this->get('session.handler.pdo.connection'), array('db_table' => 'sessions', 'db_id_col' => 'sess_id', 'db_data_col' => 'sess_data', 'db_time_col' => 'sess_time', 'db_lifetime_col' => 'sess_lifetime', 'db_user_id_col' => 'sess_user_id'), $this->get('security.context'));
    }
    ...
    protected function getTemplating_Helper_AssetsService()
    {
        ...
        return $this->services['templating.helper.assets'] = $this->scopedServices['request']['templating.helper.assets'] = new \Symfony\Component\Templating\Helper\CoreAssetsHelper(new \Symfony\Bundle\FrameworkBundle\Templating\Asset\PathPackage($this->get('request'), '6.7.4', '%s?%s'), array());
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('hmecnu9qe7wck48wo04ckcsc0k80o8c');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'zh_CN',
            'secret' => 'hmecnu9qe7wck48wo04ckcsc0k80o8c',
            'user_partner' => 'none',
            ...
            'kernel.secret' => 'hmecnu9qe7wck48wo04ckcsc0k80o8c',
            ...
            'twig.options' => array(
                ...
                'paths' => array(
                    'F:\\wamp2.5\\www\\wlkt_cms\\edusoho\\app/../web/customize' => 'customize',
                    'F:\\wamp2.5\\www\\wlkt_cms\\edusoho\\app/../src/Topxia/WebBundle/Resources/views' => 'topxiaweb',
                    'F:\\wamp2.5\\www\\wlkt_cms\\edusoho\\app/../web/themes' => 'theme',
                    'F:\\wamp2.5\\www\\wlkt_cms\\edusoho\\app/../' => 'root',
                ),
