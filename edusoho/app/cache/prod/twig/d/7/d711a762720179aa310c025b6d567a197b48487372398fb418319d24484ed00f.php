...
class __TwigTemplate_d711a762720179aa310c025b6d567a197b48487372398fb418319d24484ed00f extends Twig_Template
{
                  ...
                  ";
                    ...
                    if (($this->getAttribute($context["order"], "status", array()) == "created")) {
                      ...
                      <li>
                        <a href=\"";
                        // line 82
                        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("pay_center_show", array("sn" => $this->getAttribute($context["order"], "sn", array()))), "html", null, true);
