...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/register')) {
            ...
            // register_nickname_update
            if ($pathinfo === '/register/nickname/update') {
                return array (  '_controller' => 'Topxia\\WebBundle\\Controller\\RegisterController::nicknameUpdateAction',  '_route' => 'register_nickname_update',);
            }
        ...
        if (0 === strpos($pathinfo, '/course')) {
            ...
            if (0 === strpos($pathinfo, '/course/se')) {
                // course_select
                ...
                // course_search
                if ($pathinfo === '/course/search') {
                    return array (  '_controller' => 'Topxia\\WebBundle\\Controller\\CourseController::searchAction',  '_route' => 'course_search',);
                }
        ...
        if (0 === strpos($pathinfo, '/qrcode')) {
            // common_learn_qrcode
            if ($pathinfo === '/qrcode/generate') {
                return array (  '_controller' => 'Topxia\\WebBundle\\Controller\\CommonController::generateLearnQrcodeAction',  '_route' => 'common_learn_qrcode',);
            }

            // common_parse_qrcode
            if (0 === strpos($pathinfo, '/qrcode/parse') && preg_match('#^/qrcode/parse/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'common_parse_qrcode')), array (  '_controller' => 'Topxia\\WebBundle\\Controller\\CommonController::parseLearnCodeAction',));
            }
